...
public class DepartmentServiceImpl implements DepartmentService {
	...
	@Override
	public Department fetchDepartmentByName(String departmentNmae) {
		
		return departmentRepository.findByDepartmentNmae(departmentNmae);
	}

	@Override
	public Department fetchDepartmentByNameIgnoreCase(String departmentNmae) {
		// TODO Auto-generated method stub
		return departmentRepository.findByDepartmentNmaeIgnoreCase(departmentNmae);
	}
	}
