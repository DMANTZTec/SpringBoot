...
public class MyTask {
	...
	private List<HourSpentDetails> hourspentdetails;
	...
	public List<HourSpentDetails> getHourspentdetails() {
		return hourspentdetails;
	}
	public void setHourspentdetails(List<HourSpentDetails> hourspentdetails) {
		this.hourspentdetails = hourspentdetails;
	}
