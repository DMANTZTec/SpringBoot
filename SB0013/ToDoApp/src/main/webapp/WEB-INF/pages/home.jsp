...
<html lang="en">
  ...
  <div class="container mt-3">
    ...
    <div class="col-md-10">
        ...
        <c:if test="${page =='home' }">
        <h1 class="text-center">All TODOS  
        </h1>
        </c:if>
        ...
        <div class="form-group">
           <form:textarea path="todoContent" cssControl="form-control" placeholder="Enter your todo content" cssStyle="height:300px; width:1000px; bottom:10px;"></form:textarea>
